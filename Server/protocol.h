...
enum ENUM_TYPE{
    ...
    ENUM_TYPE_SECURITY_SCAN_REQUEST,
    ENUM_TYPE_SECURITY_SCAN_RESPOND,
    ENUM_TYPE_UNSAFE_FILE_NOTIFY,
    ENUM_TYPE_UNSAFE_FILE_DEL_REQUEST,
    ENUM_TYPE_AI_ANALYZE_REQUEST,
    ENUM_TYPE_AI_ANALYZE_RESPOND,
    ENUM_TYPE_AI_REPORT_REQUEST,
    ENUM_TYPE_AI_REPORT_RESPOND,
    ENUM_TYPE_MAX=99999,
};
